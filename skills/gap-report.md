...
**Based on:** 40 job offers across Germany, Netherlands, Canada, Portugal + [`skill-map.md`](skill-map.md) self-assessment

Phase 1 research: [`docs/phase1-country-research.md`](../docs/phase1-country-research.md)  
...
See [`../learning/backlog.md`](../learning/backlog.md) for execution waves.
