...
Then add individual offer files with [`_offer-template.md`](_offer-template.md) when you apply or need full detail. Save as `by-country/<code>/offer-<company>-<role-slug>.md`.
