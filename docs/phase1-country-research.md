# Phase 1 — Country Research & Skill Gap Analysis

> Job Migration Workflow for Emad Poursina | Full-Stack JavaScript Engineer

---

## Critical context: Iranian passport restrictions (2026)

Before selecting countries, these hard blockers must be acknowledged:

- **USA**: Full visa suspension for Iranian nationals effective January 1, 2026 (Proclamation 10998). No work visas are currently being issued.
- **UAE**: Entry banned for Iranian passport holders following recent geopolitical events (2026).
- **Australia**: Entry restrictions in place for Iranian nationals as of March 2026.

These countries are **excluded** from the priority list regardless of tech opportunity.
...
| Factor | Description |
|---|---|
| Visa Accessibility | How easy it is for an Iranian national to obtain a work visa |
| Tech Job Market | Demand for Full-Stack JS / Node.js / React developers |
| Salary vs. Cost of Living | Real purchasing power after living expenses |
| English-Friendly Work | Can you work professionally in English? |
| Path to PR | How clear and fast is the permanent residency pathway? |
...
### Secondary countries (apply but lower priority)
...
**Status:** ✅ Done (40 offers across DE, NL, CA, PT)

Full report: [`skills/gap-report.md`](../skills/gap-report.md)  
Market frequency: [`skills/requirements-summary.md`](../skills/requirements-summary.md)

### Critical gaps (20+/40 offers)

1. **AWS** (22/40)
2. **Unit & integration testing — Jest** (20/40)
3. **CI/CD — GitHub Actions / GitLab CI** (20/40)
...
- [ ] **Hand off to Phase 3** — Build learning plan from gap list (see [`learning/backlog.md`](../learning/backlog.md))
