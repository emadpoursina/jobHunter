...
Instructions for AI agents that automate parts of the jobHunter workflow.

| Guide | Phase | Purpose |
|-------|-------|---------|
| [`job-offer-research.md`](job-offer-research.md) | 1 | Find 10–15 real job offers per country for skill gap analysis |
| [`cv-generator.md`](cv-generator.md) | 2 | Generate tailored CV + Gaps Disclosure from master profile + offer file |
