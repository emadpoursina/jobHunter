...
```
Full Name:         Emad Poursina
Email:             emad.puursina@gmail.com
Phone / WhatsApp:  +98 903 632 6844
Telegram:          @emad_poursina
...
| Skill | Level | Years of Experience | Notes |
|---|---|---|---|
| Jest (unit) | Beginner / Learning | — | Flagship project — service layer tests |
| Jest (integration) | Beginner / Learning | — | Flagship project — Supertest API tests |
| Supertest | Beginner / Learning | — | Flagship project — endpoint integration tests |
...
- Led development and maintenance of web platforms
- Managed technical architecture and deployment processes
- Coordinated marketing-related technical integrations
- Oversaw reporting systems and performance optimization

Technologies used:
Node.js, Express, TypeScript, React, Next.js, MongoDB, PostgreSQL, Docker, Nginx, Linux, REST APIs
```
...
Role Title:     WordPress Developer
Type:           Freelance, Remote
Start Date:     2020
End Date:       Present

What you did:
- Designed and developed websites from ready-made templates and Figma designs
- Built personal, company, and eCommerce websites
- Custom development on plugins, themes, and scripts
...
```
Company:        Freelancer (Self-employed)
Role Title:     Full-Stack JavaScript Engineer
Type:           Freelance, Remote
Start Date:     2023
End Date:       Present
...
```
Name:           Rousta TV
URL:            https://roustatv.com/
Status:         Live
Type:           Social Platform (MERN Stack)
Role:           Sole developer
Duration:       2023 – Present (ongoing)

What it does:
A full-stack social platform built with React, Node.js, and MongoDB.

Your contributions:
- Designed and developed the full-stack social platform
- Implemented RESTful APIs and role-based access control
- Developed ad management and content moderation features
...
Type:           Task assignment and follow-up application
Role:           Sole developer

What it does:
An application for assigning and following up on different tasks.
...
### Project 3: Quiz Manager

```
Name:           Quiz Manager
URL:            https://azmoon.sujiland.com/login
Status:         Live
Type:           Quiz creation and participation platform
Role:           Sole developer

What it does:
An application for creating different quizzes that users can come and take.
...
### Project 4: CRM — Sales Campaign Manager
...
What it does:
A web app for sales campaigns where people fill out a form; their contact is
automatically assigned to sellers for follow-up calls, with a rating system for each seller.
...
### Project 5: Flagship Project (In Progress)

```
Name:           TBD — SaaS platform (portfolio flagship)
URL:            GitHub repo — to be published
Status:         In development
Type:           Full-stack SaaS with microservices architecture
Role:           Sole developer
...
- JWT + refresh token rotation and OAuth2 (Google/GitHub)
- RBAC with NestJS guards and role decorators
- PostgreSQL (Prisma) + MongoDB (polyglot persistence) + Redis (cache/sessions/queues)
- BullMQ async jobs (e.g. post-registration email)
- Next.js frontend with Apollo Client and Zustand state management
- Jest unit + Supertest integration tests (70%+ backend coverage target)
- Docker Compose local stack; AWS deploy (EC2, RDS, S3, Lambda, CloudWatch)
- GitHub Actions CI/CD pipeline (lint → tsc → test → deploy)

Technologies:
NestJS, TypeScript, PostgreSQL, Prisma, MongoDB, Redis, React, Next.js,
GraphQL (Apollo), Docker, AWS (EC2/RDS/S3/Lambda/IAM/CloudWatch), Jest, GitHub Actions

Progress: See phase3/flagship-project.md and phase3/backlog.md
```
...
**Skill map reference:** [`../../phase3/skill-map.md`](../../phase3/skill-map.md)  
**Gap report reference:** [`../../phase1/skills/gap-report.md`](../../phase1/skills/gap-report.md)
