# Live job offers (Phase 2)

Individual offer files for roles you are applying to — distinct from the Phase 1 research corpus in [`../../phase1/job-offers/`](../../phase1/job-offers/).

## Workflow

1. Find a live role (~90 days) with visa sponsorship
...
by-country/
  de/
    offer-check24-fullstack-node-react.md
  ca/
    ...
```
