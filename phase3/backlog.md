...
Prioritized from [`skill-map.md`](skill-map.md). Primary vehicle: **one flagship project** that covers all layers (see skill map).

**Status:** `todo` | `doing` | `done` | `dropped`

When `done`, add evidence to [`../phase2/profile/master-profile.md`](../phase2/profile/master-profile.md) and [`../phase1/skills/gap-report.md`](../phase1/skills/gap-report.md).
...
Market-validated from 40 offers (DE, NL, CA, PT) — see [`../phase1/skills/gap-report.md`](../phase1/skills/gap-report.md):
